...
You can make a poster using our default template using this web tool:

**https://mbeavitt.github.io/film_club/**
...
4. Save your poster:
   - Export JPEG - a shareable image for WhatsApp etc.
   - Print PDF - an A4 sheet with two A5 copies side-by-side
